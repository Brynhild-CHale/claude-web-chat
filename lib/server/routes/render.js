...
// — this file is the HTTP shell over it, plus the two BULK primitives the engine
// deliberately does not own: the pin-filtered clear-all and its batched frames.
//
...
const { setMount, lockReject, ownerReject, normalizeOwner } = require('../domain/mounts');
