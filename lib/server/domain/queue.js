...
module.exports = { enqueue, coalesce, list, remove, removeByComment, refreshComment, setStaged, flush, emitWake, parkWake, drainPending, consumePending, channelLive, ackWake, repush, foldPendingAck, foldStaleAck, revertPane, revertArtifact, isStaged, MAX_QUEUE, CONSUMER_TTL_MS, ACK_STALE_MS };
