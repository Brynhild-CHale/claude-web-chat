...
//   * the static ids in public/index.html. test/mount-engine.test.js derives
//     them from the file and fails if this set falls behind, so the set cannot
//     drift as the chrome grows.
//   * the ids the shell creates LAZILY, which that derivation cannot see.
//
