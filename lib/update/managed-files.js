...
function printResults(results) {
  const labels = {
    ...
    // A pack unit whose installed record names a path outside its own
    // directory. Nothing was touched; the record needs a human.
    refused: 'REFUSED — the installed record names a path outside its own directory',
