...
// The slug, the URLs built from it, and the comparator all live in
// lib/core/versions — this file used to declare its own second copy of the slug
// alongside release.js's, and its own RELEASES_PAGE off that copy.
const { REPO_SLUG, RELEASES_PAGE } = require('../core/versions');

// Re-exported here so existing callers (and test/version.test.js) keep
// resolving the comparator from this module.
