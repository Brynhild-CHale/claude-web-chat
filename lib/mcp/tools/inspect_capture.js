...
module.exports = {
  ...
  inputSchema: {
    ...
    properties: {
      ...
      profile: { type: 'string', description: "Re-run a named profile over the raw DOM (e.g. tables). The re-run gets the capture's own URL, so url-derived fields resolve exactly as they did at ingest." },
