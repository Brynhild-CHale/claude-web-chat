...
// Interrupting a drain that is going fine buys nothing and costs a wait we then
// have to repeat for the next row. (It used to cost more: a SIGTERM mid-drain
// re-entered the boolean-guarded gracefulShutdown, returned instantly and
// process.exit()ed before writeDraft — destroying the snapshot the ask was for
// and leaving the portfile behind. A second trigger awaits the in-flight
// shutdown now, but the reasoning for not signalling here is unchanged.)
//
