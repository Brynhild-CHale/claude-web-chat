...
module.exports = {
  ...
  // `esc` (lib/core/html's five-character escaper) rides the pane ctx — see
  // CTX_HELPERS in lib/capture/profiles/index.js. It used to be redeclared
  // inside render() on every call, in a four-character form used for `href=`
  // as well as text.
  render(d, { esc }) {
    const msgs = d.messages || [];
